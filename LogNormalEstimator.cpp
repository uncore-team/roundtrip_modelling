...
// // LogNormalEstimator class implementation
...
//         const double logxmab = log(xma/b);

//         // Update partial sums
// 		sum1 += ((1.0 + invc) - (2.0*b2invc/c)/aux)/xma;
// 		sum2 += 1.0/aux;
// 		sum3 += logxma - 2.0*logxmab/(pow(xma/b, b2invc) + 1.0);
// 	}
...
LogNormalEstimator::LogNormalEstimator() : m_min_len(10) {
// Constructor
}
