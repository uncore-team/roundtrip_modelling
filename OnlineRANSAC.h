...
class OnlineRANSAC {
public:
    OnlineRANSAC(unsigned min_len, unsigned max_len, unsigned model_preserving, unsigned sample_sliding, unsigned data_preserving, vector<ModelType> model_types);
    void reset();
...
private:
    ...
    unsigned m_sample_sliding;
    unsigned m_data_preserving;
