...
global TOLROUNDTRIPS
    ...
    alpha = min(x) - TOLROUNDTRIPS; % offset; slightly smaller than min(x) to avoid singularities in the AD test (we introduce a slight bias by doing this, but it is acceptable)
